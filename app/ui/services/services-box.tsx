...
export default function ServiceBox() {
  ...
  return (
    <div className="flex flex-col items-center flex-1 text-primary transition duration-2000 mt-10">
      <div id="service-list" className="flex justify-between w-[75%] mb-2">
        <div
          id="service-1"
          ref={ref}
          className={clsx(
      ...
      <div
        ref={ref}
        className={clsx(
          "flex mx-2 transition-all duration-2000 w-screen pb-5 justify-center h-140",
          { "opacity-100 translate-x-0": isVisible },
          { "opacity-0 translate-x-12": !isVisible },
        )}
      >
        <div className="w-[45%] max-w-2xl flex flex-col mr-2">
          <div className="bg-background p-6 relative h-full">
        ...
        <div className="bg-background-secondary w-1/2 max-w-2xl relative">
          {activeService === "service-1" ? (
            <Image
              src="/property-management.jpg"
              alt="Property Image"
              fill
              className={clsx("animate-blur-in object-cover opacity-0")}
            />
          ) : null}
          {activeService === "service-2" ? (
            <Image
